    ...
    <article class="card flex-1 m-auto w-100  z-1 bg-base-100 p-2 shadow-smrounded-box z-1 w-52 p-10">
        ...
        <div>
            <ul class="list shadow-md">
                <li class="btn btn-secondary w-75 m-auto p-5"><strong>Âge</strong> : <input type="text" :value="displayAge(age)"></li>
                <li class="btn btn-accent w-75 m-auto p-5"><strong>Âge + 10ans</strong> : <input type="text" :value="displayAge(age,10)"></li>
                <li class="btn btn-primary w-75 m-auto p-5"><strong>Nb fétiche</strong> : <input type="text" :value="nbFtich()"></li>
            </ul>
        </div>
        <div>
